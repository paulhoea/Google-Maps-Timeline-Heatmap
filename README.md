...
This .py file imports Google Timeline data ([see here](https://support.google.com/maps/thread/264641290?sjid=2994992130023812188-EU)) to generate an interactive heatmap and detail map of walking journeys.
...
Obtain Google Timeline data (usually found in Phone Settings "Location & privacy", not on the Google Account per default anymore).
